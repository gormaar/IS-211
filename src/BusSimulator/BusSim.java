...
public class BusSim {
    ...
    private PriorityQueue<Event> prioqueue = new PriorityQueue<>();
    ...
    //1a) Jeg velger å bruke PriorityQueue. Grunnen til det er at det er denne strukturen som logisk passer best til funksjonaliteten i oppgaven.
    //    dette ved at bussen skal stoppe basert på en kø, men fortsatt ta hensyn til tidspunktet for hendelsen.
